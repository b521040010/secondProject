classdef UtilityMaximizationSolverGeometric < handle
    ...
    methods
        ...
        function o = selectScenariosAndInstruments(o)
            ...
            o.geoProblem = GeometricProblem(o.nq+1+o.nq/2);
        ...
        function addPqIdentityConstraint(o)
            ...
            logProb;
            %------------------
            payy=horzcat(payy,zeros(o.nP,o.nq/2));
            payy=sparse(payy);
            ...
            o.geoProblem.addLinearConstraint( horzcat(zeros(1,o.nq),1,zeros(1,o.nq/2)) , 1, 'to make the last variable =1 , for the payoff0' ); 

        end
        
        function addCostConstraint(o)
            % The total cost of the portfolio must be OK
            vec = zeros(1,o.nq+1+o.nq/2);
            for i=1:o.nq
...
%                 end
            ...
            o.geoProblem.addLinearUpperBound(horzcat(o.costVec,zeros(1,1+o.nq/2)),0,'cost constraint');
        ...
        function addPositiveQuantityConstraint(o)
            ...
            A = horzcat(eye(o.nq), zeros(o.nq,1+o.nq/2));
            %b = zeros(o.nq,1);
            b = zeros(o.nq,1);
