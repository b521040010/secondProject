classdef PutOption < Instrument1D
    ...
    methods
        ...
        function marginal = marginal20(o,spot)
            marginal = (0.2*spot+min(o.K-spot,0))*o.contractSize+o.bid
            %marginal = (0.2*spot+min(o.K-spot,0))*o.contractSize;
        end
        function marginal = marginal10(o,spot)
            marginal = (0.1*o.K)*o.contractSize+o.bid;
            %marginal = (0.1*o.K)*o.contractSize;
        end
