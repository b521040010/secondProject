...
%             assert(~arbitrage);    
            ...
            for i=1:length(dayData.instruments)
             ...
             ump.addConstraint(MarginalRequirementConstraint(model.S0));
...
%             end     
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
        [utility, quantities,qp,m] = ump.optimize();
        m
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            totalInvestment=0;
