...
%             lp = log(weight)
        ...
        function [utility,quantities,qp,m] = optimize(o)
...
%                quantities = scaledQuantities .* scale;
             [utility,quantities,qp,m] = o.optimizeUnscaled();
        end
        ...
        function [utility,quantities,qp,m] = optimizeUnscaled(o)
            % Solve the optimization problem returning the expected
            ...
            [utility,quantities,qp,m] = solver.solve();
        end
